...
@mcp.tool()
def send_email(subject: str, body: str, to_emails: List[str],html: bool = False) -> None:
...
def onboard_new_employee(employee_name: str, manager_name: str):
    ...
    - Send a welcome email to the employee with their login credentials. (Format: employee_name@artintoo.com)
